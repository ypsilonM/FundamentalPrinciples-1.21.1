...
public class SpellCategoryLevelsAttachment {
    ...
    public static final Codec<SpellCategoryLevelsAttachment> CODEC = RecordCodecBuilder.create(spellCategoryLevelsInstance ->
            spellCategoryLevelsInstance.group(
                    Codec.unboundedMap(Codec.STRING, Codec.INT).fieldOf("categoryLevels").forGetter(SpellCategoryLevelsAttachment::getCategoryLevels),
                    Codec.unboundedMap(Codec.STRING, Codec.INT).fieldOf("categoryExperience").forGetter(SpellCategoryLevelsAttachment::getCategoryExperience)
            ).apply(spellCategoryLevelsInstance, SpellCategoryLevelsAttachment::new)
    );
    ...
    public SpellCategoryLevelsAttachment() {
        this(new HashMap<>(), new HashMap<>());
        initializeCategories();
    }
    public SpellCategoryLevelsAttachment(Map<String, Integer> categoryLevels, Map<String, Integer> categoryExperience) {
