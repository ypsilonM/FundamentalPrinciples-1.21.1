...
public class SpellCategoryProgression {
    ...
    public static SpellCategoryLevelsAttachment getCategoryLevels(Player player) {
        return player.getData(YpsAttachments.SPELL_CATEGORY_LEVELS);
    }
    ...
    public static void setCategoryLevel(Player player, String category, int level) {
        SpellCategoryLevelsAttachment levels = getCategoryLevels(player);
