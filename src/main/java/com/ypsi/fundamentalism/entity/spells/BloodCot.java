package com.ypsi.fundamentalism.entity.spells;
...
public class BloodCot extends AbstractSpellCastingMob implements IMagicSummon {
    ...
    public BloodCot(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
