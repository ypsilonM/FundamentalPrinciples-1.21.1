...
public class ImpEntity extends AbstractSpellCastingMob implements Enemy {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new SpellBarrageGoal(
                this,
                SpellRegistry.FIREBOLT_SPELL.get(), 3, 3, 40, 40, 1
        ));
        this.goalSelector.addGoal(1, new SpellBarrageGoal(
                this,
                SpellRegistry.FIREBALL_SPELL.get(),2 , 2, 200, 300, 1
        ));
...
//    }
    ...
    protected void playStepSound(BlockPos pos, BlockState state) {
        this.playSound(SoundEvents.BLAZE_AMBIENT, 0.5F,1);
    }
